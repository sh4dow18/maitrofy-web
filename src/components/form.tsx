    ...
    <>
      ...
      >
        ...
        <button
          type="submit"
          disabled={disabled}
          className="w-full mt-2 py-2 px-3 font-medium rounded-md text-center text-white bg-primary cursor-pointer hover:bg-primary-light disabled:cursor-not-allowed disabled:bg-gray-500"
        >
          {submitButton}
        </button>
      </form>
